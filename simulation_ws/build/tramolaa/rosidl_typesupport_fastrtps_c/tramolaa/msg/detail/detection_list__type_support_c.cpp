...
#include "tramolaa/msg/detail/detection_list__rosidl_typesupport_fastrtps_c.h"
...
#include "tramolaa/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "tramolaa/msg/detail/detection__functions.h"  // detections

// forward declare type support functions
size_t get_serialized_size_tramolaa__msg__Detection(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_tramolaa__msg__Detection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tramolaa, msg, Detection)();


using _DetectionList__ros_msg_type = tramolaa__msg__DetectionList;
  ...
  // Field name: detections
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, tramolaa, msg, Detection
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: detections
  {
    ...
    if (ros_message->detections.data) {
      tramolaa__msg__Detection__Sequence__fini(&ros_message->detections);
    }
    if (!tramolaa__msg__Detection__Sequence__init(&ros_message->detections, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tramolaa
size_t get_serialized_size_tramolaa__msg__DetectionList(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DetectionList__ros_msg_type * ros_message = static_cast<const _DetectionList__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_tramolaa__msg__Detection(
...
static uint32_t _DetectionList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tramolaa__msg__DetectionList(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tramolaa
size_t max_serialized_size_tramolaa__msg__DetectionList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_tramolaa__msg__Detection(
  ...
  if (is_plain) {
    ...
    using DataType = tramolaa__msg__DetectionList;
    is_plain =
      (
...
static size_t _DetectionList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tramolaa__msg__DetectionList(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tramolaa, msg, DetectionList)() {
