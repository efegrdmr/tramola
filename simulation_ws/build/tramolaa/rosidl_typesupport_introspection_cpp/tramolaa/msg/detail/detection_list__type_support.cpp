...
size_t size_function__DetectionList__detections(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<tramolaa::msg::Detection> *>(untyped_member);
  return member->size();
}

const void * get_const_function__DetectionList__detections(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__DetectionList__detections(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__DetectionList__detections(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const tramolaa::msg::Detection *>(
    get_const_function__DetectionList__detections(untyped_member, index));
  auto & value = *reinterpret_cast<tramolaa::msg::Detection *>(untyped_value);
  value = item;
}

void assign_function__DetectionList__detections(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<tramolaa::msg::Detection *>(
    get_function__DetectionList__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const tramolaa::msg::Detection *>(untyped_value);
  item = value;
}

void resize_function__DetectionList__detections(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<tramolaa::msg::Detection> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectionList_message_member_array[1] = {
  {
    ...
    offsetof(tramolaa::msg::DetectionList, detections),  // bytes offset in struct
    nullptr,  // default value
    size_function__DetectionList__detections,  // size() function pointer
    get_const_function__DetectionList__detections,  // get_const(index) function pointer
    get_function__DetectionList__detections,  // get(index) function pointer
    fetch_function__DetectionList__detections,  // fetch(index, &value) function pointer
    assign_function__DetectionList__detections,  // assign(index, value) function pointer
    resize_function__DetectionList__detections  // resize(index) function pointer
  }
};
