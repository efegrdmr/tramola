...
size_t tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__size_function__DetectionList__detections(
...
const void * tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__get_const_function__DetectionList__detections(
...
void * tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__get_function__DetectionList__detections(
...
void tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__fetch_function__DetectionList__detections(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const tramolaa__msg__Detection * item =
    ((const tramolaa__msg__Detection *)
    tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__get_const_function__DetectionList__detections(untyped_member, index));
  tramolaa__msg__Detection * value =
    (tramolaa__msg__Detection *)(untyped_value);
  *value = *item;
}

void tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__assign_function__DetectionList__detections(
  void * untyped_member, size_t index, const void * untyped_value)
{
  tramolaa__msg__Detection * item =
    ((tramolaa__msg__Detection *)
    tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__get_function__DetectionList__detections(untyped_member, index));
  const tramolaa__msg__Detection * value =
    (const tramolaa__msg__Detection *)(untyped_value);
  *item = *value;
}

bool tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__resize_function__DetectionList__detections(
...
static rosidl_typesupport_introspection_c__MessageMember tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__DetectionList_message_member_array[1] = {
  {
    ...
    offsetof(tramolaa__msg__DetectionList, detections),  // bytes offset in struct
    NULL,  // default value
    tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__size_function__DetectionList__detections,  // size() function pointer
    tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__get_const_function__DetectionList__detections,  // get_const(index) function pointer
    tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__get_function__DetectionList__detections,  // get(index) function pointer
    tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__fetch_function__DetectionList__detections,  // fetch(index, &value) function pointer
    tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__assign_function__DetectionList__detections,  // assign(index, value) function pointer
    tramolaa__msg__DetectionList__rosidl_typesupport_introspection_c__resize_function__DetectionList__detections  // resize(index) function pointer
  }
};
