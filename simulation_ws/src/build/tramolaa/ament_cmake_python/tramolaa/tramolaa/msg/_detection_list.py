...
class Metaclass_DetectionList(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('tramolaa')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'tramolaa.msg.DetectionList')
            logger.debug(
...
class DetectionList(metaclass=Metaclass_DetectionList):
    ...
    _fields_and_field_types = {
        'objects': 'sequence<tramolaa/Detection>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['tramolaa', 'msg'], 'Detection')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'objects' field must be a set or sequence and each value of type 'Detection'"
        self._objects = value
