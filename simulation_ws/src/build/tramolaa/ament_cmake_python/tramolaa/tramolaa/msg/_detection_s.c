...
bool tramolaa__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tramolaa.msg._detection.Detection", full_classname_dest, 33) == 0);
  }
  tramolaa__msg__Detection * ros_message = _ros_message;
  {  // x_center
...
PyObject * tramolaa__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tramolaa.msg._detection");
