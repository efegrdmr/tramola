...
#include "tramolaa/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tramolaa::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tramolaa::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tramolaa::msg::Detection *>(
    untyped_ros_message);
...
{
  return &tramolaa::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
