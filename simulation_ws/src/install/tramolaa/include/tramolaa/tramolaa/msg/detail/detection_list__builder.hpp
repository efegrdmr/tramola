...
class Init_DetectionList_objects
{
public:
  Init_DetectionList_objects()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::tramolaa::msg::DetectionList objects(::tramolaa::msg::DetectionList::_objects_type arg)
  {
...
{
  return tramolaa::msg::builder::Init_DetectionList_objects();
}
